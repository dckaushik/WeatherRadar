...
class DBHelper(context: Context) : SQLiteOpenHelper(context, DBHelper.DATABASE_NAME, null, DBHelper.DATABASE_VERSION) {
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        val createTable = "CREATE TABLE $TABLE_NAME ($COL_DATE_CREATED LONG PRIMARY KEY , $COL_NAME  VARCHAR(256),$COL_COUNTRY  VARCHAR(256),$COL_DESCRIPTION  VARCHAR(256), $COL_DT  VARCHAR(256))"
